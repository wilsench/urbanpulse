    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200/80">
            ...
            <div class="flex flex-wrap items-center gap-2.5">
                ...
                <form method="POST" action="{{ route('admin.cities.sync-indonesia') }}" onsubmit="return confirm('Apakah Anda yakin ingin menyinkronkan daftar kota utama di Indonesia?')">
                    @csrf
        ...
        <div class="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
            <form method="GET" action="{{ route('admin.cities.index') }}" class="flex flex-col sm:flex-row gap-3">
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors">
                                ...
                                <td class="py-4 px-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.cities.destroy', $city) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kota {{ $city->name }}?')">
                                            @csrf
                                            @method('DELETE')
